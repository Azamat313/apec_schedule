...
- `api/teachers.json` - Список преподавателей (83 человек)
- `api/schedule.json` - Данные расписания (4035 записей)
...
- **Период:** 19.01.2026 - 25.01.2026
- **Сгенерировано:** 20.01.2026 17:59
- **Всего групп:** 78
- **Преподавателей:** 83
- **Записей расписания:** 4035
